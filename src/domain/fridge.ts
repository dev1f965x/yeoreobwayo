...
/** One unit that left the fridge, and how. */
...
/** Three days, which is about as far ahead as dinner is planned. */
...
/** What has to go first, first; among equals, what came in first. */
...
/** Takes one away. The last one leaves the fridge. */
...
/** Removes whatever is left of it at once, counted as waste. */
